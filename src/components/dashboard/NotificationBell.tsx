            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="absolute right-0 mt-2 w-[min(360px,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-white/10 bg-[#0a0f1e]/95 backdrop-blur-xl shadow-2xl shadow-black/30 z-50"
                    >
                        {/* Header */}
